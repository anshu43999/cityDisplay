                            ...
                            <li v-for="item in grading" :key="item.gradedm">
                                ...
                                <div class="b-r-r">
                                    <div class="inputBox" @click="changeValue">
                                        <input class="input grade" type="number" placeholder="%"
                                               v-model="item.proportion" :data-id='item.gradedm'>
                    ...
                    <div class="settingBox1" v-if="model==='edit'">
                        <ul>
                            <li v-for="item in peak" :key="item.xzqhdm">
                                ...
                                <div class="b-r-r">
                                    <div class="inputBox">
                                        <input class="input city" type="number" v-model="item.jjslsx"
                                               :data-id='item.xzqhdm'>
                                    </div>
                                </div>
                            </li>
        ...
        methods: {
            ...
            slide(){
                ...
                if (this.click===true){
                    ...
                    icon.innerHTML='<i class="iconfont iconshezhi"></i>'
                }
            },
        },
        mounted() {
...
<style scoped lang="scss">
    ...
    #bar {
        ...
        .l{
            ...
            height:6rem;
            float: left;
            background: url("../assets/images/setting/l.png");
