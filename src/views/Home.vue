        ...
        methods: {
            ...
            jqflhbfxChart(typeArr, yesterdayArr, beforeYesterdayArr, hb) {
                ...
                myChart.on('click',params=>{
                    console.log(this.jqflObj[params.name]);
                    // console.log(this.jqflObj[params.value]);
                    /*this.$router.push({
                        name: '占比',
                        query: {
                ...
                this.$http({
                    ...
                    if (res.status===200){
                        ...
                        res.data.map(item=>{
                            ...
                            that.jqflObj[item.fldmmc]=item.fldm;
                        });
            ...
            getYxjqHb() {
                ...
                this.$http({
                    ...
                    this.mapData.hb=Math.abs(parseFloat((res.data['Sjqhbfx']['有效警情环比'] * 100).toFixed(2)));
                })
            },
            ...
            getLianHb() {
                ...
                this.$http({
                    method: 'get',
                    url: this.apiRoot + 'processHandling/processHandling',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                        'crossDomain': true
                    },
